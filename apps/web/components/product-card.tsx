    ...
    <div className="rounded-lg border border-line">
      ...
      <div className="p-3">
        ...
        <div className="mt-1.5 grid grid-cols-4 gap-2">
          ...
          <Nutrient label="protein" value={food.per_100g.protein} unit="g" />
          <Nutrient label="carbs" value={food.per_100g.carbs} unit="g" />
          <Nutrient label="fat" value={food.per_100g.fat} unit="g" />
        </div>

        {serving && servingMacros ? (
          <>
            <p className="mt-3 text-[10px] font-semibold uppercase tracking-wider text-ink-faint">
              Per serving · {serving.label} ({serving.grams} g)
            </p>
            <div className="mt-1.5 grid grid-cols-4 gap-2">
              <Nutrient label="kcal" value={servingMacros.kcal} accent />
              <Nutrient label="protein" value={servingMacros.protein} unit="g" />
              <Nutrient label="carbs" value={servingMacros.carbs} unit="g" />
              <Nutrient label="fat" value={servingMacros.fat} unit="g" />
            </div>
            {serving.note ? (
          ...
          <p className="mt-3 text-[11px] leading-snug text-ink-faint">
            No serving size on record for this product — choose the weight yourself on the next
            step.
          </p>
        )}
