            ...
            startTransition(async () => {
              ...
              setScanError(
                result.reason === "not_found"
                  ? `No product for ${code}. Search for it by name, or add it as a custom food.`
                  : result.reason === "invalid"
                    ? "That does not look like a barcode."
                    : "Could not reach the food database. Search by name instead.",
              );
            })
          }
