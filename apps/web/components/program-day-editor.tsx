...
export function ProgramDayEditor({
  ...
  return (
    <Card plain className="sm:p-5">
      ...
      {replacing ? (
        <div className="mt-4 flex h-[26rem] flex-col rounded-2xl border border-accent p-3.5">
      ...
      {picking ? (
        candidate ? (
          ...
          <div className="mt-4 flex h-[26rem] flex-col rounded-2xl border border-line/60 p-3.5">
