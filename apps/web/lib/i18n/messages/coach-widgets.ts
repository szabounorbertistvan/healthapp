...
const en = {
  ...
  nutritionBuilder: {
    ...
    onlyOn: "Only on {day}",
    addVariant: "Different on one day",
    addVariantHint: "Copies this meal onto that weekday. The everyday version keeps applying to the rest.",
    removeVariant: "Remove this day",
    status: { draft: "template", published: "published", archived: "archived" },
    publish: "Publish to client",
    published: "Published",
    draftNotice: "Template — {name} cannot see this until you publish it.",
...
const ro: typeof en = {
  ...
  nutritionBuilder: {
    ...
    onlyOn: "Doar {day}",
    addVariant: "Altfel într-o zi",
    addVariantHint: "Copiază masa pe ziua aleasă. Versiunea de zi cu zi rămâne pentru restul săptămânii.",
    removeVariant: "Șterge ziua asta",
    status: { draft: "șablon", published: "publicat", archived: "arhivat" },
    publish: "Publică pentru client",
    published: "Publicat",
    draftNotice: "Șablon — {name} nu îl vede până nu îl publici.",
