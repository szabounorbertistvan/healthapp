    ...
    pricingTiers: [
      {
        ...
        items: [
          "Your coach's programs, logged set by set — targets pre-filled, rest timer, PRs found for you",
          "Nutrition: search, 5 barcode scans a day, meal plans, macros counted against the plan",
          "Habits, streaks and weekly check-ins",
          "The last 30 days of your history, and your fitness score",
        ],
        soon: [] as string[],
        note: "No card, no expiry. Everything you log is kept — the plan only decides how far back you see it.",
      },
      {
        name: "Premium",
        audience: "client",
        items: [
          ...
          "Weight, waist and volume trends, every PR, and how your fitness score moved",
          "Progress photos compared side by side",
          "Unlimited barcode scans, favourites, own programs and custom exercises",
          "Your own exercise demo videos and a customisable share card",
        ],
        soon: [] as string[],
        note: "Included at no cost when your coach is on Coach Pro.",
      },
      {
        name: "Coach Starter",
        audience: "coach",
        items: [
          "Up to 3 clients",
          "Program builder, and meal plans with the four daily targets",
      ...
      },
      {
        ...
        audience: "coach",
        items: [
          "Up to 30 clients — and each of them gets Premium included",
          "On Track / Needs Attention / Needs a Restart on every client, with the reason and the adherence %",
          "Each client's fitness score",
          "Meal plans filled with real foods and grams",
          "Duplicate days and copy whole programs between clients",
          "Unlimited custom exercises with your own YouTube demos",
        ],
        soon: [] as string[],
    ...
    pricingTiers: [
      {
        ...
        items: [
          "Programele antrenorului tău, notate set cu set — ținte precompletate, cronometru de pauză, recorduri găsite pentru tine",
          "Nutriție: căutare, 5 scanări de cod de bare pe zi, planuri de mese, macro numărate față de plan",
          "Obiceiuri, serii și check-in-uri săptămânale",
          "Ultimele 30 de zile din istoric și scorul tău de fitness",
        ],
        soon: [] as string[],
        note: "Fără card, fără expirare. Tot ce loghezi se păstrează — planul decide doar cât de departe în urmă vezi.",
      },
      {
        name: "Premium",
        audience: "client",
        items: [
          ...
          "Evoluția greutății, taliei și volumului, toate recordurile și cum s-a mișcat scorul de fitness",
          "Pozele de progres comparate una lângă alta",
        ...
        soon: [] as string[],
        note: "Inclus gratuit când antrenorul tău are Antrenor Pro.",
      },
      {
        ...
        items: [
          "Până la 3 clienți",
          "Constructor de programe și planuri de mese cu cele patru ținte zilnice",
          "Mesaje, revizuirea check-in-urilor și feedback la check-in-ul săptămânal",
          "10 exerciții proprii",
        ],
        soon: [] as string[],
      ...
      },
      {
        ...
        items: [
          ...
          "Pe drumul bun / Necesită atenție / Necesită repornire pe fiecare client, cu motivul și procentul de aderență",
          "Scorul de fitness al fiecărui client",
          "Planuri de mese completate cu alimente reale și grame",
          "Duplicare zile și copiere programe întregi între clienți",
          "Exerciții proprii nelimitate cu demo-urile tale de YouTube",
        ],
        soon: [] as string[],
