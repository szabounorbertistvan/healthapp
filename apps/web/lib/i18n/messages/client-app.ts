...
const en = {
  ...
  workout: {
    ...
    searchPlaceholder: "Search a day or an exercise…",
    filterAll: "All",
    estMinutes: "~{n} min",
    doneToday: "done today",
    lastDone: "done {when}",
    types: { chest: "Chest", back: "Back", shoulders: "Shoulders", arms: "Arms", legs: "Legs", glutes: "Glutes", core: "Core", cardio: "Cardio" },
  },
  workoutDay: {
...
const ro: typeof en = {
  ...
  workout: {
    ...
    searchPlaceholder: "Caută o zi sau un exercițiu…",
    filterAll: "Toate",
    estMinutes: "~{n} min",
    doneToday: "făcut azi",
    lastDone: "făcut {when}",
    types: { chest: "Piept", back: "Spate", shoulders: "Umeri", arms: "Brațe", legs: "Picioare", glutes: "Fesieri", core: "Core", cardio: "Cardio" },
  },
  workoutDay: {
