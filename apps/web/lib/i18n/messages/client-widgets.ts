...
const en = {
  setLogger: {
    ...
    previous: "Previous",
    previousNone: "First time — nothing to beat yet",
    previousTitle: "Previous workout",
    setN: "Set {n}",
    vsPreviousUp: "+{value} kg vs previous",
    vsPreviousDown: "−{value} kg vs previous",
    vsPreviousRepsUp: "+{value} rep vs previous",
    vsPreviousRepsDown: "−{value} rep vs previous",
    vsPreviousSame: "Same as previous",
    openExercise: "History",
  },
  restTimer: {
    title: "Rest timer",
    rest: "Rest",
...
const ro: typeof en = {
  setLogger: {
    ...
    previous: "Anterior",
    previousNone: "Prima dată — nu ai încă un reper",
    previousTitle: "Antrenamentul anterior",
    setN: "Setul {n}",
    vsPreviousUp: "+{value} kg față de anterior",
    vsPreviousDown: "−{value} kg față de anterior",
    vsPreviousRepsUp: "+{value} rep față de anterior",
    vsPreviousRepsDown: "−{value} rep față de anterior",
    vsPreviousSame: "La fel ca anterior",
    openExercise: "Istoric",
  },
  restTimer: {
